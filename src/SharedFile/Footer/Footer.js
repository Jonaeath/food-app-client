...
const Footer = () => {
    return (
        <div>
        <footer className="footer footer-center bg-green-200 p-10 text-base-content rounded">
  <nav className="grid grid-flow-col gap-4">
    <Link to='/' className="link link-hover">Home</Link>
    <Link to='/login' className="link link-hover">LogIn</Link>
    <Link to='/createuser' className="link link-hover">Registration</Link>
  ...
  <aside>
    <p>Jonaeath © 2024 - Mirpur -- Dhaka -- Bangladesh</p>
  </aside>
</footer>
</div>
    );
